...
- **钢材**: P_TYPE=1, STANDARD="JTG3362-18(S)", DB="Q345"（根据钢号调整）
...
2. Materials (/db/MATL) — use STANDARD code: JTG3362-18(RC) for concrete, JTG3362-18(S) for steel
3. Sections (/db/SECT)
4. Nodes (/db/NODE)
5. Elements (/db/ELEM)
...
- Steel: STANDARD="JTG3362-18(S)", DB="Q345" (adjust grade as needed)
